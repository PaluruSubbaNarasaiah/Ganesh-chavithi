      ...
      <header className="relative z-10 p-4 sticky top-0 bg-black/40 backdrop-blur-xl border-b border-white/10">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <Link to="/" className="flex items-center gap-3 group">
            <div className="w-10 h-10 rounded-full saffron-bg flex items-center justify-center shadow-[0_0_20px_rgba(242,125,38,0.5)] group-hover:scale-105 transition-transform">
